<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('manufacturer.index')" :active="request()->routeIs('manufacturer.index')">
                        {{ __('Manufacturers') }}
                    </x-nav-link>
                    @auth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('vendor.index')" :active="request()->routeIs('vendor.index')">
                {{ __('Vendors') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('manufacturer.index')" :active="request()->routeIs('manufacturer.index')">
                {{ __('Manufacturers') }}
            </x-responsive-nav-link>
            @auth
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                @endauth
                @if (App::isLocale('ru'))
                <x-responsive-nav-link :href="route('setlocale', ['locale' => 'en'])">
                    {{ __('English') }}
                </x-responsive-nav-link>
                @else
                <x-responsive-nav-link :href="route('setlocale', ['locale' => 'ru'])">
                    {{ __('Russian') }}
                </x-responsive-nav-link>
                @endif
                @auth
